...
public class ScoresAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        if ((cursor.getInt(COL_HOME_GOALS) > 0 && cursor.getInt(COL_AWAY_GOALS) > 0)) {
            view.setContentDescription(String.format(context.getString(R.string.card_contentdescription),
                    cursor.getString(COL_HOME), cursor.getString(COL_AWAY), cursor.getString(COL_MATCHTIME),
                    Utilies.getScores(cursor.getInt(COL_HOME_GOALS), cursor.getInt(COL_AWAY_GOALS))));
        } else {
            view.setContentDescription(String.format(context.getString(R.string.card_contentdescription_noscore),
                    cursor.getString(COL_HOME), cursor.getString(COL_AWAY), cursor.getString(COL_MATCHTIME)));
        }
